export function getFirebaseAuthErrorDescription(errorCode) {
    const errorDescriptions = {
        ...
        "auth/invalid-login-credentials": "Por favor, verifique o e-mail e a senha fornecidos e tente novamente.",
    };

    // Retorna a descrição do erro com base no código, ou uma mensagem genérica se o código do erro não for encontrado
    return errorDescriptions[errorCode] || "Código de erro desconhecido. Por favor, verifique o código fornecido e tente novamente.";
}
